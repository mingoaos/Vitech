...
--
-- Host: localhost
-- Tempo de geração: 26-Abr-2024 às 10:52
...
(1, 1, '2024-04-17 23:00:00', 'I', 'Como entrar no Inovar', 'Olá, não sei como entrar no inovar', 'DIF', 1, 'F', 1, '2024-04-18'),
(2, 2, '2024-04-24 09:00:00', 'I', 'Problema de Conexão', 'Estou enfrentando problemas de conexão com a rede interna.', 'DIF', 0, 'P', 1, NULL),
...
--
ALTER TABLE `ticket`
  MODIFY `id_ticket` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
