    ...
    <div class="d-flex justify-content-between align-items-center">
      <h6 class="m-0" style="font-weight: 800;">
        ...
        <?php if ($tipoTicket != "Não atribuidos"): ?>
          ...
          <a href="#" style="color: <?= ($filtro[1] ? 'red' : 'grey;'); ?>;" role="button"
            onclick="changeFiltro(this, '#ff0000', '1', '<?= $tipoTicket ?>')">
            Pendente
          </a>
          <span style="color: #012970;"> - </span>
          <a href="#" style="color: <?= ($filtro[2] ? 'gold' : 'grey;'); ?>;" role="button"
            onclick="changeFiltro(this, '#FFD700' ,'2', '<?= $tipoTicket ?>')">
            Aberto
          </a>
          <span style="color: #012970;"> - </span>
          <a href="#" style="color: <?= ($filtro[3] ? 'limegreen' : 'grey;'); ?>;" role="button"
            onclick="changeFiltro(this, '#32CD32', '3', '<?= $tipoTicket ?>')">
            Fechado
          </a>
